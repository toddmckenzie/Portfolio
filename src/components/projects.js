        ...
        <div className="projects">
            <div className="dorothy">
                <div className="words bunker-words">
                    <a href="https://expo.dev/@toddmckenzie/DorothysBunker" target="_blank" rel="norefferer" className="db-heading"><h1 className="project-heading db-heading">Dorothy's Bunker</h1></a>
                    ...
                    <p>
                    This mobile app was my first time working with React Native but it was a simple transition as it is so similar to ReactJs. You can access the app with the expo app at <a className="db-heading anchorT" href="https://expo.dev/@toddmckenzie/DorothysBunker" target="_blank" rel="noreferrer">https://expo.dev/@toddmckenzie/DorothysBunker</a>.
                    </p>
                    <p>Github Code: <a href="https://github.com/SheltersBunkers/Frontend" className="db-heading" target="_blank" rel="noreferrer" style={{fontSize: "26px", textDecoration: "underline"}}>Front End</a></p>
                    <p>Github Code: <a href="https://github.com/toddmckenzie/Maps-backend" className="db-heading" target="_blank"  rel="noreferrer" style={{fontSize: "26px", textDecoration: "underline"}}>Back End</a></p>
                </div>
                ...
                <img src={cloudstands} className="cloud" />
                    <div className="words">
                        <a><h1 className="project-heading cloud-heading">Cloud Stands</h1></a>
                        <h3 className="role">Full Stack Developer</h3>
                        ...
                        My role on Cloudstands was as a full stack developer, responsible for building the Frontend layout and infrastructure. Site is no longer live but code can be found below.</p>
                        <p>Github Code: <a href="https://github.com/labs14-market-organizer" target="_blank" rel="norefferer" className="cloud-heading" style={{textDecoration: "underline"}}>Front End / Back End</a></p>
                    </div>

                </div>
                <div className="didact-div">
                    <div className="words didact-words">
                        <a><h1 className="project-heading didact-heading">Didact</h1></a>
                        ...
                        <p>Github Code: <a href="https://github.com/Lambda-School-Labs/didact-fe" target="_blank" rel="norefferer" className="didact-heading" style={{fontSize: "26px", textDecoration: "underline"}}>Front End</a></p>
                        <p>Github Code: <a href="https://github.com/Lambda-School-Labs/didact-be" target="_blank" rel="norefferer" className="didact-heading" style={{fontSize: "26px", textDecoration: "underline"}}>Back End</a></p>
                    </div>
                ...
                <img src={tweet} className="tweet-pic" />
                    ...
                    <a  href="https://tweetbetterapp.netlify.com" target="_blank" rel="norefferer" >
                    ...
                    <h3 className="role">Frontend Developer</h3>
                        ...
                        <p>Github Code: <a href="https://github.com/tweet-better-build-week-2/Frontend" target="_blank"  rel="norefferer" className="TB-heading git-tweet" style={{textDecoration: "underline"}}>Frontend</a></p>
                    </div>
                </div>
        </div>
    )
